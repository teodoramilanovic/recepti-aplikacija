...
public class ReceptController {
	...
	public void deleteReceptById(@PathVariable int id, @RequestHeader(name="authorization") String header) {
		receptService.deleteReceptById(id, header);
	}
	...
	@RequestMapping("/recepti/tezinaPripreme/{tezina}")
	...
	@RequestMapping("/recepti/pocetna")
	public List<Recept> getReceptiLjudiKojePratim(@RequestHeader(name="authorization") String header) {
		return receptService.getReceptiLjudiKojePratim(header);
	}
