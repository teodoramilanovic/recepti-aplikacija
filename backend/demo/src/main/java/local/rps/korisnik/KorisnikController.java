...
public class KorisnikController {
	...
	public void updateKorisnik(@RequestBody Korisnik korisnik, @RequestHeader(name="authorization") String header) {
		korisnikService.updateKorisnik(korisnik, header);
	}
	...
	@RequestMapping(method =  RequestMethod.DELETE, value = "/korisnici")
	public void deleteKorisnikById(@PathVariable int id, @RequestHeader(name="authorization") String header) {
		korisnikService.deleteKorisnikById(header);
	}
}